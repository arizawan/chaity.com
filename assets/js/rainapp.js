...
*
*/
$(document).on("change", ".filesToUpload", function (e) {
    ...
    for (var i = 0; i < input.files.length; i++) {
        ...
        reader.onload = function (e) {
            ...
            li.innerHTML = '<img src='+e.target.result+' height="70px" width="90px" style="margin-top:2px;"/>';
            ul.appendChild(li);
        }
...
$(document).on("click", ".removeMultiInput", function (e) {
    e.preventDefault();
    $("#addGallaryImageBtn").html('');
    $("#addGallaryImageBtn").html('<input name="filesToUpload[]" id="filesToUpload" class="filesToUpload" type="file" multiple="" />');

    $("#addGallaryList").html('<button class="removeMultiInput">Remove Files</button><ul id="fileList" class="list-unstyled"><li>No Files Selected</li></ul>');
