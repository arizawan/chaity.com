      ...
      <div class="container-fluid vertical-center">
          <div class="row">
              ...
              <div class="col-xs-12 give-green-shade cht-push-left">
                  ...
                  <li>
                    <a href="/gallery/show/knitting" style="color:#fff; padding-bottom:10px;" class="galhover">Knitting</a>
                  </li>
                  <li>
                    <a href="/gallery/show/dyeing" style="color:#fff; padding-bottom:10px;" class="galhover">Dyeing</a>
                  </li>
                  <li>
                    <a href="/gallery/show/dyeing-finishing" style="color:#fff; padding-bottom:10px;" class="galhover">Dyeing Finishing</a>
                  </li>
                  <li>
                    <a href="/gallery/show/laboratory" style="color:#fff; padding-bottom:10px;" class="galhover">Laboratory</a>
                  </li>
                  <li>
                    <a href="/gallery/show/cutting" style="color:#fff; padding-bottom:10px;" class="galhover">Cutting</a>
                  </li>
                  <li>
                    <a href="/gallery/show/sewing" style="color:#fff; padding-bottom:10px;" class="galhover">Sewing</a>
                  </li>
                  <li>
                    <a href="/gallery/show/quality" style="color:#fff; padding-bottom:10px;" class="galhover">Quality</a>
                  </li>
                  <li>
                    <a href="/gallery/show/finishing-packing-area" style="color:#fff; padding-bottom:10px;" class="galhover">Finishing & Packing Area</a>
                  </li>
                  <li>
                    <a href="/gallery/show/accessories" style="color:#fff; padding-bottom:10px;" class="galhover">Accessories</a>
                  </li>
                  <li>
                    <a href="/gallery/show/factoryoverview" style="color:#fff; padding-bottom:10px;" class="galhover">Factory Overview</a>
                  </li>
                  <li>
                    <a href="/gallery/show/officeinterior" style="color:#fff; padding-bottom:10px;" class="galhover">Office Interior</a>
                  </li>
                  <li>
                    <a href="/gallery/show/etp" style="color:#fff; padding-bottom:10px;" class="galhover">ETP</a>
                  </li>
              </ul>
                    ...
                    <div style="margin-left:10px;margin-right:10px;;margin-top:2%;">
                        ...
                        <div class="row">
                          ...
                          @foreach ($data as $img)
                                    ...
                                    <a href="{{$img}}" data-lightbox="multiimages" class="col-md-2 portfolio-item galleryitem bw">
                                        <img class="img-responsive" src="{{$img}}" alt="" class="img-responsive">
                                    </a>
                                    <!--<p>Lorem Ipsum</p>-->
