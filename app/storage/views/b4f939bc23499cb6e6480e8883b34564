                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <a href="/frontend/contact-us.html" class="active">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container-fluid vertical-center">
            <div class="row">
                <div class="col-xs-12 give-green-shade cht-push-left">
                    <h1 class="left-title mark-yellow">Contact Us</h1>
                </div>
                <div class="col-xs-12 give-green-shade cht-push-right">
                    <div class="row chy-normal-text chy-onek-text chy-normal-text assign-scroll">
                        <!-------->
                        <div class="col-lg-6">
                            <div class="col-lg-12" style="margin-top: 2% !important;">
                                <div style="margin-left:0px;;margin-top:2%;">
                                    <span class="mark-yellow">Corporate Office:</span>
                                    <br> House # 08, Road # 13, Sector # 03, Urrara, Dhaka- 1230, Bangladesh
                                    <br>Phone : (+88 02) 8923670 (Hot Line)
                                    <br>Fax : (+88 02) 8913701, 8916485
                                    <br> Web Site : www.chaity.com
                                    <iframe width="100%" height="210" style="margin-top:10px;" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=Rusmat+Community+Centre,+house+no+8,++road+no+13,+sector+3,+uttara,+dhaka&amp;aq=&amp;sll=23.867401,90.398606&amp;sspn=0.001261,0.002642&amp;ie=UTF8&amp;hq=Rusmat+Community+Centre,+house+no&amp;hnear=Road+No.13,+Uttara,+Dhaka,+Dhaka+Division,+Bangladesh&amp;ll=23.866922,90.399005&amp;spn=0.006295,0.006295&amp;t=m&amp;output=embed"></iframe>
                                    <div class="col-lg-6">
                                        <span class="mark-yellow">Factory:</span>
                                        <br> Ashique Complex, 43, Chalabon,
                                        <br> Azampur, Uttara, Dhaka-1230,
                                        <br> Bangladesh
                                    </div>
                                    <div class="col-lg-6">
                                        <span class="mark-yellow">Factory:</span>
                                        <br> Chotto silmondi, Tripurdi,
                                        <br> Sonargaon, Narayanganj,
                                        <br> Bangladesh.
                                        <br>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6" style="margin-top: 2% !important; padding-right:15px !important;">
                            <!--<p>Check your mail Now &nbsp;&nbsp;&nbsp;
                      <a class="btn chy-contact-button" style="color:#fff;">WebMail <span class="glyphicon glyphicon-envelope" aria-hidden="true"></span></a></p>-->
                            <div style="margin-left:0%;margin-top:2%;width:100%;">
                                <div class="alert alert-warning" role="alert">

                                    Thank you! your mail has been sent!

                                </div>
                                <span class="mark-yellow" style="padding-bottom:20px;width:100%;float:left;">Send your Query:</span>
                                <form class="form-horizontal" style="width:100%" action="/sendcontactmobile" method="post">
                                    <fieldset>
                                        <!-- Text input-->
                                        <div class="control-group">
                                            <label class="control-label" for="textinput">Name :</label>
                                            <div class="controls">
                                                <input id="textinput" name="name" type="text" placeholder="" class="input-xlarge chy-textinp">
                                            </div>
                                        </div>
                                        <!-- Text input-->
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input id="textinput" name="cname" type="text" placeholder="" class="input-xlarge chy-textinp">
                                            </div>
                                        </div>
                                        <!-- Text input-->
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input id="textinput" name="mobile" type="text" placeholder="" class="input-xlarge chy-textinp">
                                            </div>
                                        </div>
                                        <!-- Text input-->
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input id="textinput" name="email" type="text" placeholder="" class="input-xlarge chy-textinp">
                                            </div>
                                        </div>
                                        <!-- Textarea -->
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea id="textarea" name="desc" class="chy-textinp" style="height:100px;"></textarea>
                                            </div>
                                        </div>
                                        <!-- Button -->
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <button id="singlebutton" name="sendbtn" class="btn chy-contact-button">Send</button>
                                            </div>
                                        </div>
                                    </fieldset>
                                </form>
                            </div>
                            <div style="visibility:hidden;">Chaity Group will respect the rights of employees to associate, organize and bargain collectively in a lawful and peaceful manner without penalty or interface.</div>
                        </div>
                        <!-------->
                    </div>
                </div>
